...
window.onload = function () {
    ...
    // Functions
    // -------------------------------------------------
    function generateEmptyGrid(seq1, seq2) {
        let scoreMat = [];
    ...
    // Generate alignements from 2 sequences
    ...
    buttonAlign.addEventListener("click", function () {
        ...
        // Make sure that the sequences contains the right nucletides codes : ACGT
        ...
        if (pattern.test(seq1) || seq1 == "" || pattern.test(seq2) || seq2 == "") {
            ...
            let scoreMat = generateEmptyGrid(seq1, seq2);
